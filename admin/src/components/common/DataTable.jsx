                    ...
                    <thead className={stickyHeader ? 'sticky top-0 bg-white dark:bg-slate-800 z-10' : ''}>
                        <tr className="border-b border-slate-200 dark:border-slate-700">
                            ...
                            {(onView || onEdit || onDelete) && (
                                <th className={`${sizeClasses[size]} text-right font-semibold text-slate-900 dark:text-white`}>
                                    Actions
                                </th>
                            )}
                        </tr>
                        ...
                        {loading ? (
                            ...
                            [...Array(5)].map((_, rowIndex) => (
                                <tr key={`skeleton-${rowIndex}`} className="border-b border-slate-200 dark:border-slate-700">
                                    ...
                                    {columns.map((col) => (
                                        <td key={col.key} className={`${sizeClasses[size]} border-r last:border-r-0 border-slate-200 dark:border-slate-700`}>
                                ...
                                return (
                                    <React.Fragment key={key}>
                                        ...
                                        >
                                            ...
                                            {/* Actions Column */}
                                            {(onView || onEdit || onDelete) && (
                                                <td className={`${sizeClasses[size]} text-right`} onClick={(e) => e.stopPropagation()}>
