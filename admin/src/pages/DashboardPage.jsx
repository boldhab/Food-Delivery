                ...
                >
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex gap-2">
                            {['revenue', 'orders', 'users'].map((metric) => (
                                <button
                                    key={metric}
            ...
            >
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6
                    ...
                    <div className="space-y-3">
                        {state.stats?.popularCategories?.map((cat: any, index: number) => (
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6
                    ...
                    <div className="space-y-3">
                        {state.stats?.peakHours?.map((hour: any, index: number) => (
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6
                    ...
                    <div className="space-y-3">
                        {state.stats?.recentActivity?.map((activity: any, index: number) => (
